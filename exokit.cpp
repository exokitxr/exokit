...
void InitExports(Handle<Object> exports) {
  ...
  exports->Set(v8::String::NewFromUtf8(Isolate::GetCurrent(), "_nativeGl"), glResult.first);

  std::pair<Local<Value>, Local<FunctionTemplate>> gl2Result = makeGl2(glResult.second);
  exports->Set(v8::String::NewFromUtf8(Isolate::GetCurrent(), "_nativeGl2"), gl2Result.first);
