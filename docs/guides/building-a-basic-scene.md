---
title: Building a Basic A-Frame Scene
...
[primitives]: https://aframe.io/docs/primitives/
[position]: https://aframe.io/docs/components/position
[rotation]: https://aframe.io/docs/components/rotation
[scale]: https://aframe.io/docs/components/scale

This guide is from the [official A-Frame docs](https://aframe.io/docs/master/guides/building-a-basic-scene.html).
...
[scene]: https://aframe.io/docs/core/scene
...
[abox]: https://aframe.io/docs/primitives/a-box
...
[geometry]: https://aframe.io/docs/components/geometry
[material]: https://aframe.io/docs/components/material
...
[camera]: https://aframe.io/docs/components/camera
...
> Make sure you're [serving your HTML using a local server](https://aframe.io/docs/introduction/getting-started #using-a-local-server)
...
[asset management system]: https://aframe.io/docs/core/asset-management-system
...
[sky]: https://aframe.io/docs/primitives/a-sky
...
[aplane]: https://aframe.io/docs/primitives/a-plane
...
[light]: https://aframe.io/docs/primitives/a-light
...
[animation]: https://aframe.io/docs/core/animations
...
[cursor component]: https://aframe.io/docs/components/cursor
...
[setattribute]: https://aframe.io/docs/core/entity#setattribute-componentname-value-propertyvalue-clobber
...
[text]: https://aframe.io/docs/components/texthttps://aframe.io/docs/
