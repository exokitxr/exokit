...
cmd.exe /c "$MLSDK_WIN/tools/debug/debug.py" --deploy-mpk build/magicleap/app-device/app-device.mpk build/magicleap/program-device/release_lumin_clang-3.8_aarch64/program-device
