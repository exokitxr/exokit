      ...
      'conditions': [
        ...
        ['"<!(echo $ANDROID$OCULUSMOBILE)"=="1"', {
          ...
          'sources': [
            ...
            '<!@(ls -1 deps/android/oboe/src/common/*.cpp)',
            '<!@(ls -1 deps/android/oboe/src/fifo/*.cpp)',
            '<!@(ls -1 deps/android/oboe/src/opensles/*.cpp)',
            '<!@(ls -1 deps/android/oboe/src/aaudio/*.cpp)',
          ],
          'include_dirs': [
            "<!(node -e \"console.log(require.resolve('nan').slice(0, -16))\")",
            "<!(node -e \"console.log(require.resolve('native-canvas-deps').slice(0, -9) + '/include/core')\")",
            ...
            '<(module_root_dir)/deps/android/oboe/include',
            '<(module_root_dir)/deps/android/oboe/src',
          ],
          'library_dirs': [
            "<!(echo $TOOLCHAIN_USR)",
            "<!(echo $TOOLCHAIN_LIB)",
        ...
        ['"<!(echo $ANDROID$GOOGLEVR)"=="1"', {
          ...
          'include_dirs': [
            ...
            "<!(node -e \"console.log(require.resolve('native-webrtc-deps').slice(0, -9) + '/include')\")",
            "<!(node -e \"console.log(require.resolve('native-webrtc-deps').slice(0, -9) + '/include/webrtc')\")",
            "<!(node -e \"console.log(require.resolve('native-googlevr-deps').slice(0, -9) + '/lib/include')\")",
            "<!(echo $TOOLCHAIN_LIB)",
            "<!(echo $TOOLCHAIN_INCLUDE_LIB)",
            "<!(echo $TOOLCHAIN_INCLUDE_SYSROOT)/EGL",
            "<!(echo $TOOLCHAIN_INCLUDE_SYSROOT)",
            ...
            '<(module_root_dir)/deps/exokit-bindings/egl/include',
            '<(module_root_dir)/deps/exokit-bindings/webrtc/include',
            '<(module_root_dir)/deps/googlevr/include',
            '<(module_root_dir)/deps/android/oboe/include',
            '<(module_root_dir)/deps/android/oboe/src',
          ],
          'library_dirs': [
            ...
            "<(module_root_dir)/node_modules/native-video-deps/lib2/magicleap",
            "<(module_root_dir)/node_modules/native-webrtc-deps/lib2/magicleap",
            "<(module_root_dir)/node_modules/native-googlevr-deps/lib/android/arm64-v8a"
          ],
          'libraries': [
            '-lskia',
            '-lavformat',
