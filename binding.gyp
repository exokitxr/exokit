          ...
          'conditions': [
            ['OS=="win"', {
              ...
              'include_dirs': [
                ...
                "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib/windows')\")",
              ...
              'library_dirs': [
                ...
                "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib/windows/Release')\")",
              ],
              'libraries': [
                'opengl32.lib',
                'glew32.lib',
              ...
              'copies': [
                {
                  ...
                  'files': [
                    ...
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib/windows/Resources/cef_100_percent.pak')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib/windows/Resources/cef_200_percent.pak')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib/windows/Resources/cef_extensions.pak')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib/windows/Resources/cef.pak')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib/windows/Resources/devtools_resources.pak')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib/windows/Resources/icudtl.dat')\")",
                  ]
                },
                {
                  'destination': '<(module_root_dir)/build/Release/locales/',
                  'files': [
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib/windows/Resources/locales/en-US.pak')\")",
                  ]
                },
              ],
              'defines': [
