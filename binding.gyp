      ...
      'conditions': [
        ...
        ['OS=="linux"', {
          ...
          'library_dirs': [
            ...
            "<!(node -e \"console.log(require.resolve('native-video-deps').slice(0, -9) + '/lib/linux/libpostproc')\")",
          ...
          'ldflags': [
            ...
            "-Wl,-rpath,<!(node -e \"console.log(require.resolve('native-video-deps').slice(0, -9) + '/lib/linux/libpostproc')\")",
