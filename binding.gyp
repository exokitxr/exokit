      ...
      'conditions': [
          ...
          'conditions': [
            ['OS=="win"', {
              ...
              'library_dirs': [
                ...
                "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib2/windows')\")",
              ],
              'libraries': [
                'opengl32.lib',
                'glew32.lib',
              ...
              'copies': [
                {
                  ...
                  'files': [
                    ...
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib2/windows/libcef.dll')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib2/windows/chrome_elf.dll')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib2/windows/libEGL.dll')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib2/windows/libGLESv2.dll')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib2/windows/natives_blob.bin')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib2/windows/snapshot_blob.bin')\")",
                    "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib2/windows/v8_context_snapshot.bin')\")",
            ...
            ['OS=="mac"', {
              ...
              'library_dirs': [
                ...
                "<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib3/macos')\")",
              ],
              'libraries': [
                '-framework OpenGL',
                '-framework Cocoa',
                ...
                '-lpostproc.55',
                '-lcef_dll_wrapper',
                "-F <!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib3/macos')\")",
              ...
              'link_settings': {
                'libraries': [
                  ...
                  "-Wl,-rpath,<!(node -e \"console.log(require.resolve('native-browser-deps').slice(0, -9) + '/lib3/macos')\")",
                  "-framework 'Chromium Embedded Framework'",
        ...
        ['"<!(echo $LUMIN)"=="1"', {
          ...
          'library_dirs': [
            ...
            "<(module_root_dir)/node_modules/native-browser-deps/lib5/magicleap",
            "<(module_root_dir)/node_modules/native-browser-deps/lib5/magicleap/lib",
          ],
          'libraries': [
            '-lskia',
            '-lLabSound',
            ...
            '-l:libpixman-1.so.0',
            '-l:libxcb-shm.so.0',
            '-l:libxcb-render.so.0',
            '-l:libpango-1.0.so.0',
            '-l:libthai.so.0',
            '-l:libdatrie.so.1',
            '-l:libfribidi.so.0',
            '-l:libatk-1.0.so.0',
            '-l:libatk-bridge-2.0.so.0',
            '-l:libcups.so.2',
            '-l:libgssapi_krb5.so.2',
            '-l:libkrb5.so.3',
            '-l:libk5crypto.so.3',
            '-l:libcom_err.so.2',
            '-l:libkrb5support.so.0',
            '-l:libkeyutils.so.1',
            '-l:libgnutls.so.30',
            '-l:libp11-kit.so.0',
            '-l:libidn2.so.0',
            ...
            '-l:libhogweed.so.4',
            '-l:libgmp.so.10',
            '-l:libavahi-common.so.3',
            '-l:libavahi-client.so.3',
            '-l:libatspi.so.0',
            '-l:libgcc_s.so.1',
            '-l:libc.so.6',
            '-l:ld-linux-aarch64.so.1',
            '-lcef_dll_wrapper',
          ],
          'ldflags': [
          ],
